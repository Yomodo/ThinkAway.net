...
namespace ThinkAway.Test.StringConverter
{
    [TestFixture]
    public class StringConverterPluginTest
    {
        ...
        public void Setup()
        {
            Core.StringConverter.UnregisterAllStringConverters();

            Core.StringConverter.RegisterStringConverter(new CustomStringConverter1());
            Core.StringConverter.RegisterStringConverter(new CustomStringConverter2());
        }
