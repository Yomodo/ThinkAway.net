...
namespace ThinkAway.Controls.Forms
{
    ...
    public partial class MessageBox : Form
    {
        ...
        private MessageBox(string message, string caption, params System.Windows.Forms.Button[] buttons)
        {
            ...
            {
                System.Windows.Forms.Button button = buttons[i];
                if (button != null)
                {
        ...
        public static DialogResult Show(string message, string caption, params string[] buttonText)
        {
            ...
            {
                return System.Windows.Forms.MessageBox.Show(message, caption, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1, 0);
            }

            System.Windows.Forms.Button okay = new System.Windows.Forms.Button();
            okay.Text = buttonText[0];
            okay.Name = "btnOK";
            ...
            if (buttonText.Length > 1)
            {
                ...
                cancel.Text = buttonText[1];
                cancel.Name = "btnCancel";
            }

            DialogResult result;
            using (MessageBox dialog = new MessageBox(message, caption, okay, cancel))
            {
