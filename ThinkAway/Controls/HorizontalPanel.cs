...
namespace ThinkAway.Controls
{
    ...
    public sealed class HorizontalPanel : Panel
    {
        ...
        [DefaultValue(false), Description("Gets or sets whether the control can render on an Aero glass surface."), Category("Appearance")]
