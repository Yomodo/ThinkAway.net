...
namespace ThinkAway.Controls.Renderers
{
    public class WindowsVistaRenderer : ToolStripRenderer
    {
        ...
        /// <returns></returns>
        protected static GraphicsPath CreateOverflowChevron(Size overflowButtonSize)
        {
        ...
        private void DrawVistaButtonBackground(Graphics g, Rectangle r, bool selected, bool pressed, bool checkd)
        {
            ...
            if (selected || pressed || checkd)
            {
                ...
                using (GraphicsPath clip = GraphicsTools.CreateRoundRectangle(glow, 2))
                {
                    ...
                    if (checkd)
                    {
                        glowColor = selected ? ColorTable.CheckedGlowHot : ColorTable.CheckedGlow;
                    }
        ...
        /// </summary>
        /// <param name="e"></param>
        protected void DrawVistaMenuBackground(ToolStripItemRenderEventArgs e)
        {
