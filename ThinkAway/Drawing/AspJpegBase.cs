...
namespace ThinkAway.Drawing
{
    ...
    public class AspJpegBase : IDisposable
    {
        ...
        public AspJpegBase(System.Drawing.Image oImage)
        {
        ...
        public Bitmap Copy(int lefttopx, int lefttopy, int rightbottomx, int rightbottomy)
        {
            ...
            {
                image.SetResolution(this.oCurrentImage.HorizontalResolution, this.oCurrentImage.VerticalResolution);
                Graphics.FromImage(image).DrawImage(this.oCurrentImage, new Rectangle(1, 1, image.Width, image.Height), srcRect, GraphicsUnit.Pixel);
