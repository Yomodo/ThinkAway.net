...
namespace ThinkAway.Drawing.Barcode.Common.reedsolomon
{
	...
	public sealed class GF256
	{
		...
		//UPGRADE_NOTE: Final was removed from the declaration of 'eThinkAway.Controls.XPTable '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		...
		private readonly GF256Poly _zero;
		...
		private readonly GF256Poly _one;
		...
		private GF256(int primitive)
		{
			...
			_zero = new GF256Poly(this, new int[]{0});
			_one = new GF256Poly(this, new int[]{1});
		}
