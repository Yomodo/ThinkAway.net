...
namespace ThinkAway.Drawing.Barcode.multi
{
	...
	public sealed class GenericMultipleBarcodeReader : IMultipleBarcodeReader
	{
		...
		private readonly Reader _delegateRenamed;
		
		public GenericMultipleBarcodeReader(Reader delegateRenamed)
		{
			this._delegateRenamed = delegateRenamed;
		}
		...
		private void  doDecodeMultiple(BinaryBitmap image, System.Collections.Hashtable hints, System.Collections.ArrayList results, int xOffset, int yOffset)
		{
			...
			try
			{
				result = _delegateRenamed.Decode(image, hints);
			}
