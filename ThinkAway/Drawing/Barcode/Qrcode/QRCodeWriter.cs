...
using Encoder = ThinkAway.Drawing.Barcode.qrcode.encoder.Encoder;
using QRCode = ThinkAway.Drawing.Barcode.qrcode.encoder.QRCode;
...
namespace ThinkAway.Drawing.Barcode.qrcode
{
	...
	public sealed class QRCodeWriter : IWriter
	{
		...
		private static void  SetRowColor(sbyte[] row, sbyte valueRenamed)
		{
