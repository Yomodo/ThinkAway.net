...
*/
using System;
using ThinkAway.Drawing.Barcode;
...
namespace ThinkAway.Drawing.Barcode
{
	...
	/// the String it encodes. For example, {@link ThinkAway.Drawing.Barcode.qrcode.QRCodeReader} can
	/// decode a QR code. The decoder may optionally receive hints from the caller which may help
	/// it decode more quickly or accurately.
	/// 
	/// See {@link ThinkAway.Drawing.Barcode.MultiFormatReader}, which attempts to determine what barcode
	...
	public interface Reader
	{
		...
		/// <param name="image">image of barcode to decode
		/// </param>
		/// <param name="hints">passed as a {@link java.util.Hashtable} from {@link ThinkAway.Drawing.Barcode.DecodeHintType}
