...
namespace ThinkAway.IO.ZipLib.GZip 
{
	...
	/// using System.IO;
	/// 
	/// using ThinkAway.IO.ZipLib.GZip;
	...
	public class GZipOutputStream : DeflaterOutputStream
	{
		...
		/// </summary>
        protected Crc32Checksum crc = new Crc32Checksum();
		...
		void WriteHeader()
		{
			if ( state_ == OutputState.Header ) 
			{
				...
				byte[] gzipHeader = {
					// The two magic bytes
					(byte) (GZipConstants.GzipMagic >> 8), (byte) (GZipConstants.GzipMagic & 0xff),
