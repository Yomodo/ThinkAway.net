...
namespace ThinkAway.IO.ZipLib.Zip.Compression.Streams 
{
	/// <summary>
	...
	public class DeflaterOutputStream : Stream
	{
		...
		public virtual void Finish()
		{
			...
			if (!deflater_.IsFinished) {
				throw new ZipLibBaseException("Can't deflate all input?");
			}
		...
		protected void Deflate()
		{
			...
			if (!deflater_.IsNeedingInput) {
				throw new ZipLibBaseException("DeflaterOutputStream can't deflate all input?");
			}
		}
		#endregion
