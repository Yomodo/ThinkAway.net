namespace ThinkAway.Net.Mail.Exceptions
{
	...
	/// </remarks>
    internal class PopServerLockedException : PopClientException
	{
		///<summary>
        ...
        public PopServerLockedException(string message, PopServerException innerException) : base(message,innerException)
        {
        }
	}
}