...
using MessageHeader = ThinkAway.Net.Mail.POP3.Header.MessageHeader;
...
namespace ThinkAway.Net.Mail
{
	...
	/// <see cref="POP3.MessagePart"/> for a description about the structure.<br/>
	/// <br/>
	...
	public class MailMessage
	{
		...
		public MessagePart MessagePart
	    {
	        ...
	        private set { _messagePart = value; }
	    }
