...
namespace ThinkAway.Net.Mail
{
	...
	/// <see cref="Mail.MessagePart"/> for a description about the structure.<br/>
	/// <br/>
	...
	public class Message
	{
		...
		public System.Net.Mail.MailMessage ToMailMessage()
		{
			...
			if(Headers.From != null)
				message.From = Headers.From.ToMailAddress();

			if (Headers.ReplyTo != null)
				message.ReplyTo = Headers.ReplyTo.ToMailAddress();

			if(Headers.Sender != null)
				message.Sender = Headers.Sender.ToMailAddress();
			...
			foreach (MailAddress bcc in Headers.Bcc)
			{
				if (bcc != null)
		...
		/// <br/>
		/// <see cref="Mail.MessagePart.IsText"/> for MessageParts which are considered to be text versions.<br/>
		/// <br/>
		...
		/// <br/>
		/// <see cref="Mail.MessagePart.IsAttachment"/> for MessageParts which are considered to be attachments.
		/// </summary>
