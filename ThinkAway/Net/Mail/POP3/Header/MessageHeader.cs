...
namespace ThinkAway.Net.Mail.POP3.Header
{
	/// <summary>
	...
	public sealed class MessageHeader
	{
	    ...
	    {
	        get { return _unknownHeaders; }
	        private set { _unknownHeaders = value; }
	    }
		...
		public string ContentDescription
	    {
	        ...
	        private set { _contentDescription = value; }
	    }
	    ...
	    private List<MailAddress> _dispositionNotificationTo;
        ...
        public List<MailAddress> DispositionNotificationTo
	    {
	        get { return _dispositionNotificationTo; }
	        private set { _dispositionNotificationTo = value; }
	    }
		...
		/// to the default of <see cref="Net.Mail.POP3.Header.ContentTransferEncoding.SevenBit">SevenBit</see> in accordance to the RFC.
		/// </summary>
		...
		public ContentTransferEncoding ContentTransferEncoding
	    {
	        ...
	        private set { _contentTransferEncoding = value; }
	    }
		...
		public ContentDisposition ContentDisposition
	    {
	        ...
	        private set { _contentDisposition = value; }
	    }
		...
		public string MimeVersion
	    {
	        ...
	        private set { _mimeVersion = value; }
	    }

	    private MailAddress _returnPath;

	    /// <summary>
		/// A single <see cref="MailAddress"/> with no username inside.<br/>
		...
		internal MessageHeader(NameValueCollection headers)
		{
			...
			To = new List<MailAddress>(0);
            Cc = new List<MailAddress>(0);
            Bcc = new List<MailAddress>(0);
		...
		private void ParseHeader(string headerName, string headerValue)
		{
			...
			switch (headerName.ToUpperInvariant())
			{
				...
				case "TO":
                    To = MailAddress.ParseMailAddresses(headerValue);
					break;

				// See http://tools.ietf.org/html/rfc5322#section-3.6.3
				case "CC":
                    Cc = MailAddress.ParseMailAddresses(headerValue);
					break;

				// See http://tools.ietf.org/html/rfc5322#section-3.6.3
				case "BCC":
                    Bcc = MailAddress.ParseMailAddresses(headerValue);
					break;

				// See http://tools.ietf.org/html/rfc5322#section-3.6.2
				case "FROM":
					// There is only one MailAddress in the from field
                    From = MailAddress.ParseMailAddress(headerValue);
					break;
				...
				case "REPLY-TO":
                    ...
                    ReplyTo = MailAddress.ParseMailAddress(headerValue);
					break;

				// http://tools.ietf.org/html/rfc5322#section-3.6.2
				case "SENDER":
                    Sender = MailAddress.ParseMailAddress(headerValue);
					break;
				...
				case "KEYWORDS":
					...
					foreach (string keyword in keywordsTemp)
					{
                        ...
                        Keywords.Add(StringHelper.RemoveQuotesIfAny(keyword.Trim()));
					}
					break;
				...
				case "DISPOSITION-NOTIFICATION-TO":
                    DispositionNotificationTo = MailAddress.ParseMailAddresses(headerValue);
					break;
				...
				case "RETURN-PATH":
                    ...
                    ReturnPath = MailAddress.ParseMailAddress(headerValue);
					break;
