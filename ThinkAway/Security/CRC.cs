...
namespace ThinkAway.Security
{
    ...
    public class CRC
    {
        ...
        /// 
        /// </summary>
        protected static readonly UInt32[] CrcTable = {
                                                          0x0,
        ...
        /// </summary>
        protected static readonly byte[] CrcHigh =
            {
        ...
        /// CRC地位校验码checkCRCLow
        /// </summary>
        protected static readonly byte[] CrcLow =
            {
        ...
        public static Int16 CRC16(byte[] data)
        {
            int i = 0;
            byte crcHigh = 0xFF;
            byte crcLow = 0xFF;
            ...
            while (length-- > 0)
            {
                byte index = (Byte)(crcHigh ^ data[i++]);
                crcHigh = (Byte)(crcLow ^ CrcHigh[index]);
                crcLow = CrcLow[index];
            }
        ...
        /// 快速检测算法  
        /// </summary>  
        public static Int32 CRC32(byte[] data)
        {
            int length = data.Length;
