...
namespace ThinkAway.Text.Json.Bson
{
        ...
        case BsonType.Integer:
          {
            ...
            _writer.Write(System.Convert.ToInt32(value.Value, CultureInfo.InvariantCulture));
          }
          break;
        case BsonType.Long:
          {
            BsonValue value = (BsonValue)t;
            _writer.Write(System.Convert.ToInt64(value.Value, CultureInfo.InvariantCulture));
          }
          break;
        case BsonType.Number:
          {
            BsonValue value = (BsonValue)t;
            _writer.Write(System.Convert.ToDouble(value.Value, CultureInfo.InvariantCulture));
          }
          break;
