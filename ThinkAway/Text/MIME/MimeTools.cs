...
namespace ThinkAway.Text.MIME
{
	...
	public class MimeTools {
		...
		/// <returns>A <see cref="System.Collections.IEnumerable" /> collection of <see cref="MimeAddress" /></returns>
		public static System.Collections.IEnumerable parseFrom ( System.String from ) {
			return MimeAddressCollection.Parse (from);
		}
		/// <summary>
		...
		public static System.String rfc2047decode ( System.String word ) {
			...
			for ( int i=0; i<words.GetLength (0); i++ ) {
				...
				switch (wordetails[2]) {
					case "q":
					case "Q":
						word += MimeTools.QuotedPrintable2Unicode ( wordetails[1], wordetails[3] ).Replace ('_', ' ');;
						break;
					case "b":
					case "B":
						try {
